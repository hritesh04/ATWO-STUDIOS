...
export default function Services() {
  ...
  return (
    <section
      id="services"
      className="relative w-full h-auto lg:h-[736px] flex flex-col lg:flex-row overflow-hidden bg-primary-red"
    >
      ...
      {/* Right — Red panel */}
      <motion.div
        className="relative h-full bg-primary-red mb-6"
        initial={
          mounted && isMd
        ...
        whileInView={
          mounted && isMd
            ? { width: "50%", opacity: 1, x: 0, y: 0, padding: "55px" }
                    ...
                    <div className="grid md:grid-cols-3 gap-8 justify-between m-4 overflow-hidden">
                      ...
                      <div className="">
                        {service.bullets?.map((bullet, i) => (
                          <p key={i} className="text-white text-[20px]">
                            ✓ {bullet}
                          </p>
                        ))}
                      </div>
