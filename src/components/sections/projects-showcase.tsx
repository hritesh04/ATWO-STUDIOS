...
function Card({
  ...
  return (
    <div
      key={project.name}
      ref={container}
      className=" h-[80vh] md:h-[120vh] w-full md:w-[90%] flex items-start justify-center sticky top-0 pointer-events-none pt-28"
    >
      <motion.div
...
export default function ProjectsShowcase() {
  ...
  return (
    <section className="relative w-full bg-black pt-[20vh] md:pt-[80vh]">
      ...
      <div
        ...
        className="relative z-10 w-full md:px-10 flex flex-col items-center md:pb-18"
      >
